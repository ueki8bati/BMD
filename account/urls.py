...
urlpatterns = [
    path('', views.TopView.as_view(), name='top'), #トップ
    ...
    path('signup_done/', views.SignupDone.as_view(), name='signup_done'), #サインイン完了
    path('user_update/<int:pk>', views.UserUpdate.as_view(), name='user_update'), #ユーザー情報更新
